...
#define RTMP_OUTPUT_CHUNK_SIZE     1460 //最小128
...
public:
    ...
    int CreateC0C1(char *o_pcBuf,int i_iMaxBufLen);
    int CreateC2(char *i_pcS1,int i_iS1Len,char *o_pcBuf,int i_iMaxBufLen);
    int CreateCmdConnect(char *i_strAppName,char *i_strTcURL,unsigned char* o_pbBuf, int i_iBufMaxLen);
    int CreateCmdCreateStream(unsigned char* o_pbBuf, int i_iBufMaxLen);
    int CreateCmdPlay(char *i_strStreamName,unsigned char* o_pbBuf, int i_iBufMaxLen);
    int CreateCmdPublish(char *i_strStreamName,unsigned char* o_pbBuf, int i_iBufMaxLen);
    int CreateCmdDeleteStream(unsigned char* o_pbBuf, int i_iBufMaxLen);
